...
import type { Constructable, mixin } from "../mod.ts"
...
const Mix1 = <c extends Constructable>(s: c) =>
...
const Mix2 = <c extends Constructable<Base>>(s: c) =>
  class Mix2 extends s {
    // mixin methods here
    constructor(...args: any[]) {
      super(...args);
    }
...
const Mix3 = <c extends Constructable>(s: c) =>
  class Mix2 extends s {
    // mixin methods here
...
const Mix4 = <c extends Constructable>(s: c) =>
  class Mix2 extends s {
    // mixin methods here
    constructor(...args: any[]) {
      super(...args);
...
const Mix5 = <c extends Constructable>(s: c) =>
  class Mix2 extends s {
    // mixin methods here
    constructor(...args: any[]) {
      super(...args);
...
const Mix6 = <c extends Constructable>(s: c) =>
  class Mix2 extends s {
    // mixin methods here
    constructor(...args: any[]) {
      super(...args);
...
const MixNoConstructor = <c extends Constructable>(s: c) =>
  class Mix2 extends s {
  };
