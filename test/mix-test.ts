...
Deno.test('applies mixins in order', () => {
  ...
  mod.assert(isApplicationOf(Object.getPrototypeOf(Object.getPrototypeOf(i)), M2));
  mod.assert(isApplicationOf(Object.getPrototypeOf(Object.getPrototypeOf(Object.getPrototypeOf(i))), M1));
  mod.assert(Object.getPrototypeOf(Object.getPrototypeOf(Object.getPrototypeOf(Object.getPrototypeOf(i)))), Object.getPrototypeOf(S));
});
...
Deno.test('mix() can omit the superclass', () => {
  ...
  mod.assert(isApplicationOf(Object.getPrototypeOf(Object.getPrototypeOf(i)), M), 'isApplicationOf');
