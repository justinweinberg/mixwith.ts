 ...
 */
  with<A extends Constructable, B extends Constructable, C extends Constructable, D extends Constructable, E extends Constructable, F extends Constructable>
    ...
    if (f_m && e_m && d_m && c_m && b_m && a_m) {
      return f_m(e_m(d_m(c_m(b_m(a_m(this.superclass)))))) as Base & A & B & C & D & E & F
    }
    else if (e_m && d_m && c_m && b_m && a_m) {
      return e_m(d_m(c_m(b_m(a_m(this.superclass))))) as Base & A & B & C & D & E & F
    }
    else if (d_m && c_m && b_m && a_m) {
      return d_m(c_m(b_m(a_m(this.superclass)))) as Base & A & B & C & D & E & F
    }
    else if (c_m && b_m && a_m) {
